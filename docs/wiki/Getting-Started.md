...
Read **[For Formalization Experts](For-Formalization-Experts.html)** for the Lean 4 architecture: 146 .lean files, 14 axioms at K7-Lean main (4 prediction-chain + 10 K3 interval certificates), 213-conjunct certificate, zero sorry. See **[Lean Formalization](Lean-Formalization.html)** for the full picture.
