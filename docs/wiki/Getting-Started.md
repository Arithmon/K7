...
Read **[For Formalization Experts](For-Formalization-Experts.html)** for the Lean 4 architecture: 146 .lean files, 15 classified axioms (A-F taxonomy, of which 4 external data packages), 213-conjunct certificate, zero sorry. See **[Lean Formalization](Lean-Formalization.html)** for the full picture.
